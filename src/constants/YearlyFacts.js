export default {
  ...
  1951: {
    facts: [
      ...
      `Ike Turner, ex-husband of Tina Turner, recorded what is considered by many to be the first rock and roll song, Rocket 88`,
    ],
  },
  1952: {
    facts: [
  ...
  1955: {
    facts: [
      `Swiss engineer George de Mestral took his dog on a hike. When he got home, he noticed there were many burrs on the dog. He examined one under the microscope. He noticed that the burrs had small hooks that enabled them to cling to the soft fur. De Mestral patented Velcro in 1955."`,
  ...
  1959: {
    facts: [
      ...
      `William Rankin, a pilot, ejected from his jet at 45,000 feet and spent the next 40 minutes being thrusted up and down inside of a thunderstorm. He survived but decided not to fly again for awhile`,
      `In testimony before congress, gameshow contestant Charles Van Doren admitted he had been coached before appearing on NBC's 21 game show in 1956. This put a major dent in the game show industry and was later recreated in the popular movie Quiz Show`,
    ],
  },
  1960: {
    facts: [
      ...
      `The 1960's film Where The Boys Are was where the idea of spring breaks in school and college originated from. Prior to that spring break was more of a college swim team thing in Florida.`,
  ...
  1961: {
    facts: [
      ...
      `USSR’s Yuri Gagarin became the first man in space, giving them the lead in the Space Race.`,
    ],
  },
  1962: {
    facts: [
      ...
      `Vasili Arkhipov, a senior officer on a Soviet submarine, refused to launch a nuclear torpedo from his higher command in October 1962, perhaps preventing WWIII`,
  ...
  1970: {
    facts: [
      ...
      `John Lennon paid all of the fines for 96 people who had been arrested for protesting against the apartheid to the South Africa rugby team playing in Britain.`,
    ],
  },
  1971: {
    facts: [
  ...
  1981: {
    facts: [
      `Code of the Secret Service was a movie which lead actor/director Ronald Reagan called "the worst picture I ever made." The film inspired a man named Jerry Sparr to join the Secret Service, who in 1981, saved President Ronald Reagan from an assassination attempt.`,
  ...
  1982: {
    facts: [
      ...
      `A Los Angeles man named Larry Walters used a lawn chair and weather balloons to ascend to 15,000ft above ground. On the way up, he lost both his glasses and his bb gun, which he planned to use to shoot balloons to descend. While landing, he caused a power outage, and was fined $1500.`,
  ...
  1984: {
    facts: [
      ...
      `Celebrity astronomer Carl Sagan, actor Martin Sheen, the Pentagon Papers whistleblower Daniel Ellsberg and PGP-creator Phil Zimmermann were in police jail together at the same time. They had been arrested after breaking into the Nevada nuclear test site.`,
  ...
  1994: {
    facts: [
      ...
      `Howard Stern talked a suicidal caller out of jumping off the George Washington Bridge live on the radio.`,
    ],
  },
  1995: {
    facts: [
      ...
      `Windows 95 was the second most installed piece of software on computers in 1995. The videogame DOOM was first.`,
  ...
  1997: {
    facts: [
      `Alex Trebek and Pat Sajak swapped places on Jeopardy! and Wheel of Fortune as an April Fool's Day joke in 1997`,
  ...
  2005: {
    facts: [
      ...
      `Mark Zuckerberg offered to sell Facebook to Myspace. Myspace CEO Chris DeWolfe rejected Zuckerberg's asking price of $75 million dollars. Mark Zuckerberg  is now worth more than $75 billion dollars.`,
    ],
  },
  2006: {
    facts: [
  ...
  2009: {
    facts: [
      ...
      `10 year old Colby Curtin, suffering from cancer, had a dying wish to watch Pixar's Up, which led to a Pixar employee flying down with a DVD of the movie for a private screening of the film. That would be last movie that Colby ever saw`,
      `Disney considered making 'The Dark Kingdom' at Walt Disney World, a Fifth Park that was themed around its villains.`,
    ],
  },
  2010: {
    facts: [
  ...
  2018: {
    facts: [
      ...
      `In 2018, bots accounted for more than 50% of all internet traffic.`,
    ],
  },
  2019: {
    facts: [
      `A lost ancient continent was discovered in the Mediterranean`,
      `A beetle was scientifically classified after climate activist teenager Greta Thunberg`,
      `Michelle Obama's "Becoming" took one year to become the most succesful book sold in the United States as well as the most succesful memoir ever written`,
    ],
  },
  2020: {
    facts: [
      `The U.K. officially left the Europena Union, ending Brexit.`,
      `Tesla became the most valuable car company ever surpassing competitors with a market cap of $300 billion`,
      `One of the craziest years in modern history saw controversial North Korean leader, Kim Jong-Un alledgedly pass away on the operating table by many mainstream media outlets, only to appear fine the next day.`,
    ],
  },
};
