...
import {
  closePlaylistPopup,
  getPopupData,
} from "../../concepts/playlist-popup";
import Modal from "../../components/Modal";
import "./PlaylistPopup.scss";
    ...
    return (
      <Modal>
        <div className="playlist-popup">
          ...
          <p className="playlist-popup__info">
            ...
            {!!playlistImage && (
              ...
              >
                <img
                  src={playlistImage}
                  alt="Playlist cover"
                  className="playlist-popup__image"
                />
              </a>
            )}
          ...
          <div className="playlist__buttons">
            ...
            <button
              onClick={this.props.closePlaylistPopup}
              className="btn btn-inline btn-default"
            >
              Close
            </button>
          </div>
